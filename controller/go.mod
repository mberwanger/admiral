module github.com/mberwanger/admiral/controller

go 1.24.1

require (
	github.com/mberwanger/admiral/client v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/mberwanger/admiral/server v0.0.0-00010101000000-000000000000 // indirect
