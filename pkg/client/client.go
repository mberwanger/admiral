...
import (
	...
	applicationv2 "go.admiral.io/admiral/api/application/v1"
	"go.admiral.io/admiral/api/cluster/v1"
	"go.admiral.io/admiral/pkg/client/metadata"
)
...
type serviceClient struct {
	applicationv2.ApplicationAPIClient
...
func (c *Client) dialGRPC(ctx context.Context, hostPort string) error {
	...
	c.grpc = serviceClient{
		ApplicationAPIClient: applicationv2.NewApplicationAPIClient(c.conn),
...
func (c *Client) CreateApplication(ctx context.Context, request *applicationv2.CreateApplicationRequest) (*applicationv2.CreateApplicationResponse, error) {
